...
> 2026 the site serves a corpus of **95,136 closings**: the corpus files
...
not evidence. That is 16,200 of them, and they have their own list.
...
| **The corpus** | built by `poster/build-corpus.js` into `dist/` | 95,136 closings and 16,200 unclassified pictures, as immutable, versioned, static shards. Hosted on Cloudflare Pages; `CORPUS_BASE` in `app.js` is the only thing that names where. |
...
**The corpus.** These built and maintain the 95,136 closings the site
